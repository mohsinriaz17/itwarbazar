...
class AStallSelectionScreen extends Component {
...
state={
  ...
  onPress={()=>{this.props.navigation.navigate('AStallScreen',{stall:this.state.alphavalue+""+this.state.numvalue});}}
/>
</Card>
	</ScrollView>
    );
...
export default AStallSelectionScreen;